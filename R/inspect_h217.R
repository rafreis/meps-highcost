...
DTA_PATH <- file.path(PROJECT_ROOT, "data", "raw", "HC-217", "h217.dta")
...
writeLines(nms, file.path(PROJECT_ROOT, "data", "raw", "HC-217", "VARNAMES_h217.txt"))
cat("\nFull variable list written to VARNAMES_h217.txt\n")
